...
addpath('./Maxmin_util/')
load('./Rician_channel/channel_Test(8, 100, 3, 10, 2000, 10, 100, 90).mat');
...
str = sprintf('./results_data/Proposed[w=v]_LS_L3_ULnoise70_tauw1000_LSTM21_NoIncrease30_block3_moving02.mat');
