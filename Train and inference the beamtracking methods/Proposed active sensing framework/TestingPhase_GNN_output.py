...
def GNN_output_proposed_approach(cell_UE_all, MLP_w_in, MLP_V_in, MLP_F_in,
    ...
    """
        :return: V_subblocks_all: tensor(batch_size, (num_elements_irs + 1), subblocks_L), dtype: Complex64
    ...
    return V_subblocks_all, w_her_complex, F_complex, mean_Estimated_error, Estimated_MISO_allUE_Tensor
