...
n_epochs = 10000 #10000  # Num of epochs
...
for frame in range(frames):
    ...
    if frame == 0:
        ...
        with tf.Session() as sess:
            ...
            h_fetch, cell_fetch = sess.run([h_old_init_fetch_all, cell_old_init_fetch_all], feed_dict=feed_dict_val)
    ...
    with tf.Session() as sess:
        ...
        best_loss, Minrate_block_test, h_fetch, cell_fetch, w_fetch, F_fetch, Estimated_MISO_fetch = sess.run([loss, Minrate_count, h_old_fetch_all, cell_old_fetch_all, w_her_complex, F_complex_testing, Estimated_MISO_allUE_Tensor], feed_dict=feed_dict_val)
